...
describe('cmd.image', function () {
    ...
    it('build()', function (done) { return __awaiter(_this, void 0, void 0, function () {
        var ex_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4, cmd.image.build('docker_cmd_js_mysql', {
    ...
    it('build() and replace', function (done) { return __awaiter(_this, void 0, void 0, function () {
        var ex_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
