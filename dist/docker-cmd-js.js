...
var Cmd = (function () {
    ...
    Cmd.prototype.runWithoutDebug = function (command, noNewLines) {
        var _this = this;
    ...
    Cmd.prototype.checkForDanglingImages = function (cb) {
        var _this = this;
    ...
    Cmd.prototype.machineStatus = function (cb) {
    ...
    Cmd.prototype.runStartMachine = function (memory) {
        var _this = this;
        return Q.Promise(function (resolve, reject) {
            ...
            _this.runWithoutDebug("docker images --format {{.Repository}} " + imageName, true).then(function (img) {
                if (img == imageName) {
                    if (opts && opts.buildAndReplace) {
                        _this.removeImage(imageName).then(function () { _this.runBuildImage(imageName, opts).then(resolve, reject); }, reject);
                    }
                    else {
                        var promptOpts = {
                            type: 'list',
    ...
    Cmd.prototype.startContainer = function (imageName, opts, command) {
        var _this = this;
        return Q.Promise(function (resolve, reject) {
